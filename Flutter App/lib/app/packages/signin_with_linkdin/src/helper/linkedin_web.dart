...
class LinkedinWeb implements LinkedinCore {
  ...
  @override
  Future<void> signIn(BuildContext context, {required LinkedInConfig config, OnGetAuthToken? onGetAuthToken, OnGetUserProfile? onGetUserProfile, OnSignInError? onSignInError, PreferredSizeWidget? appBar}) async {
    ...
    window.onMessage.listen((event) {
      ...
      if (data.contains(config.redirectUrl)) {
        ...
        authorizeUser(data, onGetAuthToken: onGetAuthToken, onGetUserProfile: onGetUserProfile, onSignInError: onSignInError);
      }
    });
  }
