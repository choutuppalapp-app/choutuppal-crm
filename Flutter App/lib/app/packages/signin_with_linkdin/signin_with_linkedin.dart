...
final class SignInWithLinkedIn {
  ...
  static Future<void> signIn(BuildContext context, {required LinkedInConfig config, OnGetAuthToken? onGetAuthToken, OnGetUserProfile? onGetUserProfile, OnSignInError? onSignInError, PreferredSizeWidget? appBar}) async {
    LinkedInApi.instance.config = config;
    _linkedinCore.signIn(context, config: config, onGetAuthToken: onGetAuthToken, onGetUserProfile: onGetUserProfile, onSignInError: onSignInError);
  }
