...
class NoSupportTicketScreen extends StatefulWidget {
  ...
  const NoSupportTicketScreen({super.key, this.message = MyStrings.noSupportTicket, this.paddingTop = 6, this.imageHeight = .5, this.message2 = MyStrings.noSupportTicketToShow, this.image = MyImages.noSupportTicketFound});
