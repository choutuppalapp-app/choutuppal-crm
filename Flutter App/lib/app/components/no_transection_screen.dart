...
class NoTransectionScreen extends StatefulWidget {
  ...
  const NoTransectionScreen({super.key, this.message = MyStrings.noTransection, this.paddingTop = 6, this.imageHeight = .5, this.imageColor = MyColor.white, this.message2 = MyStrings.noTransectionsToShow, this.image = MyImages.noTransectionFound});
                    ...
                    child: Column(
                      children: [
                        Text(
                          ...
                          style: theme.textTheme.titleSmall?.copyWith(color: MyColor.getBodyTextColor(), fontSize: Dimensions.space15),
                        ),
