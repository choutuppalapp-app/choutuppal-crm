        ...
        Container(
          ...
          child: Padding(
            ...
            child: DropdownButton(
              isExpanded: true,
              underline: Container(),
              hint: Text(widget.selectedValue?.tr ?? '', style: widget.selectedTextStyle ?? theme.textTheme.labelMedium?.copyWith(color: MyColor.black)), // Not necessary for Option 1
              ...
              items: widget.list!.map((value) {
                return DropdownMenuItem(
                  value: value,
                  child: Row(
                    children: [Text(value.tr, style: widget.itemTextStyle ?? theme.textTheme.labelMedium?.copyWith(color: MyColor.black))],
                  ),
                );
              }).toList(),
            ),
