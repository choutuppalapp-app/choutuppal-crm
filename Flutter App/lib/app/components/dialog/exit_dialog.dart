        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: CustomElevatedBtn(isLoading: false, bgColor: MyColor.white, borderColor: MyColor.getBorderColor(), text: MyStrings.no.tr, onTap: () => Get.back()),
                ),
                spaceSide(Dimensions.space15),
                Expanded(
                  child: CustomElevatedBtn(isLoading: false, text: MyStrings.yes.tr, loaderColor: MyColor.lightPrimary, bgColor: MyColor.white, textColor: MyColor.getErrorColor(), borderColor: MyColor.lightSuccess, onTap: () => SystemNavigator.pop()),
                ),
              ],
            ),
          ],
