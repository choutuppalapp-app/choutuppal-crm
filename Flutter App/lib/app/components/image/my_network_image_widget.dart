...
class MyNetworkImageWidget extends StatelessWidget {
  ...
  final Color? color;
  const MyNetworkImageWidget({super.key, required this.imageUrl, this.height = 80, this.width = 100, this.radius = 5, this.boxFit = BoxFit.cover, this.isProfile = false, this.color});
