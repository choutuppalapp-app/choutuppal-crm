        ...
        ? widget.animatedLabel
              ? TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: theme.textTheme.labelMedium?.copyWith(color: Theme.of(context).textTheme.titleLarge?.color?.withValues(alpha: 0.8)),
              ...
              : Column(
                  ...
                  children: [
                    LabelTextInstruction(text: widget.labelText.toString(), isRequired: widget.isRequired, instructions: widget.instructions),
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: theme.textTheme.labelLarge?.copyWith(color: MyColor.getBodyTextColor().withValues(alpha: 0.7)),
                        fillColor: widget.fillColor.withValues(alpha: .08),
                        filled: true,
                        border: OutlineInputBorder(
