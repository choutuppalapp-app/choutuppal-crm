...
class AllContactShimmer extends StatefulWidget {
  ...
  const AllContactShimmer({super.key, this.isContactList = false, this.isViewContactList = false, this.isViewContactTagList = false});
            ...
            children: [
              MyShimmerWidget(
                child: Container(
                  ...
                  decoration: BoxDecoration(color: MyColor.getBodyTextColor(), borderRadius: BorderRadius.circular(Dimensions.space5)),
                ),
              ),
