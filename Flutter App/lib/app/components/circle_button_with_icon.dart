    ...
    return isIcon
        ? GestureDetector(
            ...
            child: Container(
              ...
              child: isSvg ? CustomSvgPicture(image: imagePath, height: iconSize, width: iconSize, color: iconColor) : Icon(icon, color: iconColor, size: iconSize),
            ),
          )
        : GestureDetector(
            onTap: onTap,
            child: Container(
              ...
              child: isAsset
                  ? CircleAvatar(
                      ...
                      child: CircleImageWidget(isProfile: isProfile, isAsset: true, imagePath: imagePath, width: imageSize, height: imageSize),
                    )
                  : CircleAvatar(
                      backgroundColor: MyColor.getTransparentColor(),
