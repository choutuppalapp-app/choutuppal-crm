...
class AlphabetAvatar extends StatelessWidget {
  ...
  Color _getColorFromLetter(String letter) {
    final colors = [Colors.red, Colors.blue, Colors.green, Colors.orange, Colors.purple, Colors.teal, Colors.cyan, Colors.deepOrange, Colors.pink, Colors.indigo, Colors.brown, Colors.deepPurple, Colors.amber, Colors.lime, Colors.lightBlue, Colors.lightGreen, Colors.yellow, Colors.blueGrey, Colors.grey, Colors.black];
