...
class NoNotificationScreen extends StatefulWidget {
  ...
  const NoNotificationScreen({super.key, this.message = MyStrings.noNotification, this.paddingTop = 6, this.imageHeight = .5, this.message2 = MyStrings.noNotificationToShow, this.image = MyImages.noNotificationFound});
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: theme.textTheme.titleSmall?.copyWith(color: MyColor.getBodyTextColor(), fontSize: Dimensions.fontDefault),
              ),
