...
class DeleteDialogue extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          MyAssetImageWidget(assetPath: MyImages.danger, width: Dimensions.space40.h, height: Dimensions.space40.h, color: MyColor.lightError),
          ...
          Row(
            children: [
              ...
              Expanded(
                child: CustomElevatedBtn(isLoading: isLoading, text: MyStrings.yes.tr, loaderColor: MyColor.lightPrimary, bgColor: MyColor.white, textColor: MyColor.lightSuccess, borderColor: MyColor.lightSuccess, onTap: onTap),
              ),
            ],
          ),
        ],
