    ...
    return AnnotatedRegionWidget(
      ...
      child: Scaffold(
                  ...
                  leading: showBackButton
                      ? FittedBox(
                          ...
                          child: GestureDetector(
                            ...
                            child: MyAssetImageWidget(height: Dimensions.space24.h, width: Dimensions.space24.h, assetPath: MyImages.arrowBack, isSvg: true),
                          ),
                        )
                      : SizedBox.shrink(),
                  titleSpacing: 0,
                  title: showAppBarContent
                      ? Transform(transform: Matrix4.translationValues(transformValue ?? -30.0, 0.0, 0.0), child: appBarContent)
                      : Transform(
                          transform: Matrix4.translationValues(showBackButton ? 0 : -30.0, 0.0, 0.0),
                          child: Text(
                            "$pageTitle",
                            style: MyTextStyle.heading20W700().copyWith(color: MyColor.appBarTitleColor, fontSize: titleFontSize.sp),
                          ),
                        ),
                  actions: [
                    ...
                    if (demo == true && actionButton == null)
                      TextButton(
                        style: TextButton.styleFrom(
                          ...
                          textStyle: TextStyle(fontSize: Dimensions.fontLarge, fontWeight: FontWeight.w600, decoration: TextDecoration.underline, decorationColor: MyColor.getPrimaryColor()),
                        ),
                        onPressed: () {},
        ...
        body: Container(
          ...
          decoration: isScaffoldBgImage ? BoxDecoration(image: DecorationImage(image: AssetImage(screenBgImage))) : null,
          child: body,
        ),
        floatingActionButtonLocation: isCenterFloating ? FloatingActionButtonLocation.centerDocked : FloatingActionButtonLocation.endDocked,
