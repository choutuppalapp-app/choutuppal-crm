        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                CircleButtonWithIcon(circleSize: 50, imageSize: 40, padding: 0, borderColor: Colors.transparent, isIcon: false, isAsset: false, imagePath: controller.imageUrl, isProfile: true, onTap: () {}),
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(MyStrings.editProfile.tr, style: theme.textTheme.bodySmall?.copyWith(color: MyColor.white)),
                      ],
                    ),
                  ),
                ),
            ...
            Row(
              children: [
                CircleShapeImage(imageColor: MyColor.getAccent1Color(), image: MyImages.name, backgroundColor: MyColor.getPrimaryColor()),
            ...
            Row(
              children: [
                CircleShapeImage(imageColor: MyColor.getAccent1Color(), image: MyImages.email, backgroundColor: MyColor.getPrimaryColor()),
                const SizedBox(width: Dimensions.space15),
