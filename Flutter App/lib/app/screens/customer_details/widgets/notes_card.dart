  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CustomerDetailsController>(
      builder: (controller) => Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.space8), color: MyColor.getCardBackgroundColor()),
        child: Column(
              ...
              children: [
                Expanded(
                  child: Text(
                    ...
                    style: theme.textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.w600, color: MyColor.getHeadingTextColor()),
                  ),
                ),
                controller.deletingIndex == index
                    ...
                    : GestureDetector(
                        ...
                        child: MyAssetImageWidget(assetPath: MyImages.delete, isSvg: true, height: Dimensions.space16.h, width: Dimensions.space16.h),
                      ),
              ],
            ),
            spaceDown(Dimensions.space4.h),
            controller.conversation?.notes?[index].updatedAt != null ? Text(DateConverter.convertUtcToLocalTime(controller.conversation?.notes?[index].createdAt ?? ""), style: theme.textTheme.labelMedium) : SizedBox(),
          ],
        ),
      ),
    );
