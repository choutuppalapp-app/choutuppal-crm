                        ...
                        children: [
                          controller.contact?.image != null
                              ? Container(
                                  ...
                                  child: FittedBox(
                                    fit: BoxFit.cover,
                                    child: MyNetworkImageWidget(height: 40, width: 40, imageUrl: "${UrlContainer.domainUrl}/${controller.imagePath}/${controller.contact?.image}", boxFit: BoxFit.cover),
                                  ),
                                )
                              : AlphabetAvatar(firstname: controller.contact?.firstname ?? "", lastName: controller.contact?.lastname ?? ''),
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text("${controller.contact?.firstname ?? ""} ${controller.contact?.lastname ?? ""}", style: theme.textTheme.headlineSmall),
                                    InkWell(
                                      onTap: () {
                                        Get.toNamed(RouteHelper.customerAccountScreen, arguments: [controller.imagePath, controller.contact, true])?.then((_) {
                                          controller.customerDetailsData(forceLoad: false);
                                        });
                                      },
                                      child: Row(
                                        children: [
                                          MyAssetImageWidget(assetPath: MyImages.edit, isSvg: true, height: Dimensions.space16.h, width: Dimensions.space16.h),
                                ...
                                GestureDetector(
                                  ...
                                  child: Text("+${controller.contact?.mobileCode}${controller.contact?.mobile ?? ""}", style: theme.textTheme.labelMedium?.copyWith(color: MyColor.getBodyTextColor())),
                                ),
                              ],
                            ),
                          ),
                          ...
                          tabs: [
                            Tab(
                              child: Container(
                                ...
                                decoration: BoxDecoration(color: controller.currentIndex == 0 ? MyColor.getPrimaryColor() : MyColor.white, borderRadius: BorderRadius.circular(Dimensions.space8.w)),
                                child: Center(
                                  child: Text(MyStrings.details.tr, style: theme.textTheme.titleSmall?.copyWith(color: controller.currentIndex == 0 ? MyColor.getHeadingTextColor() : MyColor.getBodyTextColor())),
                                ),
                              ),
                            ),
                            Tab(
                              child: Container(
                                ...
                                decoration: BoxDecoration(color: controller.currentIndex == 1 ? MyColor.getPrimaryColor() : MyColor.white, borderRadius: BorderRadius.circular(Dimensions.space8.w)),
                                child: Center(
                                  child: Text(MyStrings.notes.tr, style: theme.textTheme.titleSmall?.copyWith(color: controller.currentIndex == 1 ? MyColor.getHeadingTextColor() : MyColor.getBodyTextColor())),
                                ),
                              ),
                            ),
                          ],
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                CustomTextField(labelText: MyStrings.addNote.tr, needOutlineBorder: true, fillColor: MyColor.getCardBackgroundColor(), hintText: MyStrings.writeDescription.tr, isPassword: false, controller: controller.noteController, maxLines: 4, isShowSuffixIcon: false, onSuffixTap: () {}, onChanged: (value) {}),
                                spaceDown(Dimensions.space25.h),
                                CustomElevatedBtn(
