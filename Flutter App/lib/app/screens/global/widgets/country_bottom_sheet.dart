                          ...
                          child: Row(
                            children: [
                              Padding(
                                ...
                                child: MyNetworkImageWidget(imageUrl: UrlContainer.countryFlagImageLink.replaceAll("{countryCode}", countryItem.countryCode!.toLowerCase()), height: Dimensions.space25, width: Dimensions.space40 + 2),
                              ),
                              Padding(
                                padding: const EdgeInsetsDirectional.only(end: Dimensions.space10),
                                child: Text('+${countryItem.dialCode}', style: theme.textTheme.bodyLarge?.copyWith()),
                              ),
                              Expanded(child: Text('${countryItem.country}', style: theme.textTheme.bodyMedium?.copyWith())),
                            ],
                          ),
                        ),
                      );
