...
class UserProfileBanner extends StatelessWidget {
  ...
  final bool isUpload;
  const UserProfileBanner({super.key, this.trailingWidget, required this.title, required this.subTitle, this.isBackButton = false, this.isUpload = false});
      ...
      children: [
        isBackButton
            ? InkWell(
                ...
                child: MyAssetImageWidget(isSvg: true, boxFit: BoxFit.scaleDown, height: 20.h, width: 20.w, assetPath: MyImages.arrowBack),
              )
            : SizedBox.shrink(),
              ...
              ? Material(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.space50.r), color: MyColor.getPrimaryColor()),
