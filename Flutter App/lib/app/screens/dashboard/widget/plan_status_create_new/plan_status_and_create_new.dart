...
class PlanStatusAndCreateNew extends StatelessWidget {
  ...
  const PlanStatusAndCreateNew({super.key, required this.planStatusTap, required this.createNewTap, this.isShowStatus = true});
      ...
      child: Row(
        ...
        children: [
          ...
          if (MyUtils.checkPermission(AppPermission.addCampaign)) ...[
            MyUtils.checkPermission(AppPermission.viewSubscription) ? spaceSide(Dimensions.space16.w) : SizedBox.shrink(),
