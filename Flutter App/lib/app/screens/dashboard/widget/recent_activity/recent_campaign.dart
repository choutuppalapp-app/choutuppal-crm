                  ...
                  child: Row(
                    children: [
                      DefaultText(
                        ...
                        textStyle: MyTextStyle.subHeading16W400(fontFamily: 'Nunito').copyWith(color: MyColor.getPrimaryColor(), fontSize: 14.sp),
                      ),
                      MyAssetImageWidget(assetPath: MyImages.arrowForward, isSvg: true, height: 18.h, width: 18.w, color: MyColor.getPrimaryColor()),
                    ],
                  ),
                ),
              ],
