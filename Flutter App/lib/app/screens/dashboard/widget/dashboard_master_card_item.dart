...
class DashBoardMasterCardItem extends StatelessWidget {
  ...
  const DashBoardMasterCardItem({super.key, this.image, this.amount, this.type, required this.bgColor, required this.gradientColor, this.onTap});
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(begin: AlignmentDirectional.topEnd, end: AlignmentDirectional.center, colors: [gradientColor, MyColor.white]),
          ),
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: MyAssetImageWidget(isSvg: true, assetPath: image ?? "", height: 27.h, width: 27.w, color: MyColor.white),
              ),
              DefaultText(
                text: amount.toString(),
                textStyle: MyTextStyle.heading20W700().copyWith(color: MyColor.usdTextColor, fontWeight: FontWeight.w600),
              ),
