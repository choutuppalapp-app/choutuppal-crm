              ...
              children: [
                    ...
                    controller.isHomeDataLoading
                        ? MyShimmerWidget(
                            child: Container(
                              ...
                              decoration: BoxDecoration(color: Colors.grey, borderRadius: BorderRadius.circular(Dimensions.space12.r)),
                            ),
                          )
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          DefaultText(
                                            ...
                                            textStyle: MyTextStyle.subHeading12W600().copyWith(color: e.isDefault.toString() == "1" ? MyColor.getPrimaryColor() : MyColor.getBodyTextColor()),
                                          ),

                                          e.isDefault.toString() == "1" ? Icon(Icons.check_circle, size: Dimensions.space15.sp, color: e.isDefault.toString() == "1" ? MyColor.getPrimaryColor() : MyColor.getBodyTextColor()) : Icon(Icons.circle_outlined, size: Dimensions.space15.sp, color: MyColor.getBodyTextColor()),
                                        ],
                                      ),
                                    ),
                                  )
                              ...
                              child: Row(
                                children: [
                                  DefaultText(
                                    ...
                                    textStyle: MyTextStyle.subHeading12W600().copyWith(color: MyColor.getHeadingTextColor()),
                                  ),
                                  RotatedBox(
                                    quarterTurns: controller.numShowed ? 10 : 0,
                                    child: MyAssetImageWidget(boxFit: BoxFit.scaleDown, assetPath: MyImages.arrowDown, height: Dimensions.space20.h, width: Dimensions.space20.h, isSvg: true),
                                  ),
                                ],
                              ),
                            ),
                ...
                Visibility(
                  ...
                  child: RoundIconWithBgColor(
                    isOnTap: true,
                    onTap: () {
                      Get.toNamed(RouteHelper.customerAccountScreen, arguments: [controller.imagePath, null, false, -1, false]);
                    },
