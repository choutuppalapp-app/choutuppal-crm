              ...
              body: controller.isHomeDataLoading
                  ...
                  : NestedScrollView(
                      ...
                      headerSliverBuilder: (context, innerBoxIsScrolled) {
                        return [
                          SliverAppBar(
                            ...
                            pinned: false,
                            toolbarHeight: 135.h,
                            flexibleSpace: FlexibleSpaceBar(titlePadding: EdgeInsets.zero, title: HeaderContent(controller)),
                          ),
                      ...
                      body: TabBarView(
                        ...
                        children: [
                          RefreshIndicator(onRefresh: () async => controller.newChatMethod(), child: MySliverTabBarView(index: 0)),
                          RefreshIndicator(onRefresh: () async => controller.newChatMethod(), child: MySliverTabBarView(index: 1)),
                          RefreshIndicator(onRefresh: () async => controller.newChatMethod(), child: MySliverTabBarView(index: 2)),
                          RefreshIndicator(onRefresh: () async => controller.newChatMethod(), child: MySliverTabBarView(index: 3)),
                        ],
                      ),
                    ),
            ),
