...
class BottomNavItem extends StatelessWidget {
  ...
  const BottomNavItem({super.key, required this.selectedIcon, required this.title, required this.isSelected, required this.onTap, this.iconSize = 24, required this.unSelectedIcon});
