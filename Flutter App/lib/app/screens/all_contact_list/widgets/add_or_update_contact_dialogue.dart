        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.only(topLeft: Radius.circular(Dimensions.space8), topRight: Radius.circular(Dimensions.space8)),
            ),
            width: double.infinity,
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(widget.isUpdate ? MyStrings.editContactList : MyStrings.newContactList.tr, style: theme.textTheme.headlineMedium?.copyWith(color: MyColor.getHeadingTextColor())),
                GestureDetector(
                  onTap: () {
                    Get.back();
                  },
                  child: MyAssetImageWidget(assetPath: MyImages.roundedCancel, isSvg: true, height: Dimensions.space24.h, width: Dimensions.space24.h),
                ),
              ],
            ),
          ),
