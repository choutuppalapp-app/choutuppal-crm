                          ...
                          children: [
                            PopupMenuButton<int>(
                              ...
                              child: Container(
                                ...
                                child: MyAssetImageWidget(assetPath: MyImages.add, isSvg: true, color: MyColor.getPrimaryColor(), height: Dimensions.space24.h, width: Dimensions.space24.h),
                              ),
                            ),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                padding: EdgeInsets.all(Dimensions.space12.h),
                                decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.space8.h), color: MyColor.white),
                                child: MyAssetImageWidget(assetPath: MyImages.gallery, isSvg: true, color: MyColor.getPrimaryColor(), height: Dimensions.space24.h, width: Dimensions.space24.h),
                              ),
                            ),
                            spaceSide(Dimensions.space8.w),
                            ChatBox(),
