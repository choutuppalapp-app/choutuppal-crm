          ...
          return controller.campaignData.isEmpty
              ...
              : NotificationListener<ScrollNotification>(
                    ...
                    if (notification is ScrollUpdateNotification) {
                      ...
                      if (metrics.pixels >= metrics.maxScrollExtent - 100) {
                        if (!controller.isLoadingMore && controller.hasNext()) {
                          controller.getCampaignData(loadMore: true, status: controller.status, searchQuery: controller.searchQuery);
                        }
                      }
                    }
                    return false;
                  ...
                  child: CustomScrollView(
                    slivers: [
                      SliverList(
                        delegate: SliverChildBuilderDelegate(childCount: controller.campaignData.length, (context, index) {
