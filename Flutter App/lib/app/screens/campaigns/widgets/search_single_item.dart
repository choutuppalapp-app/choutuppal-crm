...
class SearchSingleItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: isSelected ? MyColor.selectedSearchItemBgColor : MyColor.searchItemBgColor, borderRadius: BorderRadius.circular(Dimensions.space50.r)),
      child: Center(
        //
        child: DefaultText(
          text: title,
          textStyle: MyTextStyle.subHeading14W600().copyWith(color: isSelected ? MyColor.selectedSearchItemTextColor : MyColor.lightBodyText),
