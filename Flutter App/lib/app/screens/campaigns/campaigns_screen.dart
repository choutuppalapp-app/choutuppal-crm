                ...
                headerSliverBuilder: (context, innerBoxIsScrolled) {
                  return [
                    SliverAppBar(
                      ...
                      pinned: false,
                      toolbarHeight: 130.h,
                      flexibleSpace: FlexibleSpaceBar(titlePadding: EdgeInsets.zero, title: UserBannerAndSearchSlivers()),
                    ),
                    SliverPersistentHeader(pinned: true, delegate: CampaignTabDelegate(controller.campaignSearchItemList)),
                  ];
                },
                body: TabBarView(
