                      ...
                      Row(
                        ...
                        children: [
                          ...
                          DefaultText(
                            ...
                            textStyle: MyTextStyle.heading20W700().copyWith(color: MyColor.regularHederColor, fontSize: 16.sp),
                          ),
                              ...
                              Material(
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    Get.back();
                                    controller.selectTemplateController.text = controller.templatesList[index].name ?? "";
                                  },
                                  child: Padding(
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            DefaultText(
                                              ...
                                              textStyle: MyTextStyle.heading20W700(fontFamily: 'Nunito').copyWith(fontWeight: FontWeight.w600, fontSize: 14.sp, color: MyColor.fieldTitleTextColor),
                                            ),
                                          ],
                                        ),
                                      ],
                          ...
                          return Column(
                            children: [
                              Material(
                                child: InkWell(
                                  onTap: () {
                                    controller.selectedWhatsAppAccountId = controller.whatsappAccountList[index].id.toString();
                                    Get.back();
                                    controller.selectWhatsAppAccount.text = "${controller.whatsappAccountList[index].businessName} (${controller.whatsappAccountList[index].phoneNumber ?? ''})";
                                  },
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(vertical: 10.h),
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            DefaultText(
                                              text: "${controller.whatsappAccountList[index].businessName} (${controller.whatsappAccountList[index].phoneNumber ?? ''})",
                                              textStyle: MyTextStyle.heading20W700(fontFamily: 'Nunito').copyWith(fontWeight: FontWeight.w600, fontSize: 14.sp, color: MyColor.fieldTitleTextColor),
                                            ),
                                          ],
                                        ),
                              ...
                              Material(
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    controller.selectContactListController.text = controller.selectContactList.isNotEmpty ? "${MyStrings.selectedContactList.tr} (${controller.selectContactList.length})" : MyStrings.selectContactList.tr;
                                  },
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(vertical: Dimensions.space12.h, horizontal: Dimensions.space12.w),
                                    child: Row(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        DefaultText(
                                        ...
                                        Icon(isSelected ? Icons.check_circle : Icons.circle_outlined, color: isSelected ? MyColor.getPrimaryColor() : MyColor.fieldTitleTextColor, size: 18.sp),
                                      ],
                                    ),
                                  ),
                                ),
                              ...
                              Material(
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    controller.selectContactTagController.text = controller.selectContactTag.isNotEmpty ? "${MyStrings.selectedContactTags.tr} (${controller.selectContactTag.length})" : MyStrings.selectContactTag.tr;
                                  },
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(vertical: Dimensions.space12.h, horizontal: Dimensions.space12.w),
                                    child: Row(
