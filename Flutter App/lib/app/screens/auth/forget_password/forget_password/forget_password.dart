...
class _ForgetPasswordScreenState extends State<ForgetPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return ImageBgWidget(
      isAppBar: true,
      customAppBar: CustomAppBar(fromAuth: true, isShowBackBtn: true, title: MyStrings.forgetPassword.tr, bgColor: Colors.transparent),
            ...
            child: Column(
              ...
              children: [
                ...
                LabelTextField(
                  ...
                  prefixIcon: Icon(CupertinoIcons.mail, color: MyColor.fieldTitleTextColor, size: Dimensions.inputIconSize + 2),
                ),
