                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(color: MyColor.getPrimaryColor().withValues(alpha: .07), shape: BoxShape.circle),
                        child: CustomSvgPicture(image: MyImages.emailVerifyImage, height: 50, width: 50, color: MyColor.getPrimaryColor()),
                      ),
                      spaceDown(Dimensions.space25),
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 25),
                        child: DefaultText(text: '${MyStrings.verifyPasswordSubText.tr} : ${controller.getFormatedMail().tr}', textAlign: TextAlign.center, textColor: MyColor.getBodyTextColor()),
                      ),
                      ...
                      Padding(
                        ...
                        child: PinCodeTextField(
                          ...
                          pinTheme: PinTheme(shape: PinCodeFieldShape.box, borderWidth: 1, borderRadius: BorderRadius.circular(5), fieldHeight: 40, fieldWidth: 40, inactiveColor: MyColor.getBorderColor(), inactiveFillColor: MyColor.getScaffoldBackgroundColor(), activeFillColor: MyColor.getScaffoldBackgroundColor(), activeColor: MyColor.getPrimaryColor(), selectedFillColor: MyColor.getScaffoldBackgroundColor(), selectedColor: MyColor.getPrimaryColor()),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          controller.isResendLoading
                              ? SizedBox(height: 17, width: 17, child: CircularProgressIndicator(color: MyColor.getPrimaryColor()))
                              : TextButton(
                                  onPressed: () {
