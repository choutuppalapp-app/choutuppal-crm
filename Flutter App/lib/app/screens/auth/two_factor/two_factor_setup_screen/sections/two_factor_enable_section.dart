              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Text(MyStrings.addYourAccount.tr, style: theme.textTheme.titleMedium?.copyWith(color: MyColor.getHeadingTextColor())),
                      ),
                      const CustomDivider(),
                      Center(
                        child: Text(MyStrings.useQRCODETips.tr, style: theme.textTheme.titleMedium?.copyWith(color: MyColor.getHeadingTextColor())),
                      ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                        child: Text(MyStrings.enable2Fa.tr, style: theme.textTheme.titleMedium?.copyWith(color: MyColor.getHeadingTextColor())),
                      ),
                      const CustomDivider(),
                      Padding(
