  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Center(
          child: Container(
            decoration: BoxDecoration(color: MyColor.getTransparentColor(), borderRadius: BorderRadius.circular(Dimensions.defaultRadius)),
            child: Image.network(
              qrImage,
              width: 220,
              height: 220,
        ...
        Padding(
          ...
          child: GestureDetector(
            ...
            child: Padding(
              ...
              child: DottedBorder(
                options: RoundedRectDottedBorderOptions(dashPattern: [10, 5], strokeWidth: 2, color: MyColor.getBorderColor().withValues(alpha: 0.5), radius: Radius.circular(Dimensions.defaultRadius)),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(secret, style: theme.textTheme.titleMedium?.copyWith(fontSize: Dimensions.fontDefault + 5)),
                      ),
                      SizedBox(
                        width: 50,
                        height: 50,
