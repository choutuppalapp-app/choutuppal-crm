  ...
  Widget build(BuildContext context) {
    ...
    return WillPopWidget(
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(fromAuth: true, title: MyStrings.smsVerification.tr, isShowBackBtn: true, isShowActionBtn: false, bgColor: theme.appBarTheme.backgroundColor),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomElevatedBtn(
                            ...
                            borderColor: controller.currentText.length != 6 ? MyColor.lightTextFieldFillColor : MyColor.lightButtonBorderBorder,
                            bgColor: controller.currentText.length != 6 ? MyColor.lightTextFieldFillColor : MyColor.getPrimaryColor(),
                            textColor: controller.currentText.length != 6 ? MyColor.getBorderColor() : MyColor.getHeadingTextColor(),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(MyStrings.didNotReceiveCode.tr, style: theme.textTheme.labelMedium?.copyWith(color: MyColor.getBodyTextColor())),
                              ...
                              controller.resendLoading
                                  ...
                                  : GestureDetector(
                                      ...
                                      child: Text(
                                        ...
                                        style: theme.textTheme.labelMedium?.copyWith(decoration: TextDecoration.underline, color: MyColor.getPrimaryColor()),
                                      ),
                                    ),
                            ],
                          ),
