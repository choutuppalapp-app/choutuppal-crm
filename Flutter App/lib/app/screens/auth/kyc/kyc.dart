                                    ...
                                    if (model.type == "file") ...[
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            children: [
                                              Text(MyStrings.supportedFileType, style: theme.textTheme.bodySmall?.copyWith(color: MyColor.getBodyTextColor())),
                                              Text(' ${model.extensions}', style: theme.textTheme.bodySmall?.copyWith(color: MyColor.getBodyTextColor())),
                                            ],
                                          ),
