    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(widget.isPending ? MyStrings.kycUnderReviewMsg.tr : MyStrings.kycAlreadyVerifiedMsg.tr, style: theme.textTheme.labelMedium?.copyWith(color: MyColor.black)),
