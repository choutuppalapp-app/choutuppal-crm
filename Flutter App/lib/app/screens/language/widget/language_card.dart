    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Spacer(),
          Icon(index == selectedIndex ? Icons.check : Icons.arrow_forward_ios_rounded, color: index == selectedIndex ? MyColor.getPrimaryColor() : MyColor.getBodyTextColor().withValues(alpha: 0.5), size: Dimensions.space16.w),
        ],
      ),
    );
  }
