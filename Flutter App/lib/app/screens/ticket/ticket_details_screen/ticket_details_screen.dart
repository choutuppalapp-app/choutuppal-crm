            ...
            if (controller.model.data?.myTickets?.status != '3')
              Padding(
                ...
                child: TextButton(
                  ...
                  child: Text(MyStrings.close, style: theme.textTheme.bodyLarge?.copyWith(color: MyColor.getErrorColor())),
                ),
              ),
          ],
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [ReplySection(), MessageListSection()]),
                        ),
                      ],
                    ),
                  ),
