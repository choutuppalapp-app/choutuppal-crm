              ...
              child: SizedBox(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (item.image?.isNotEmpty ?? false) ...{Image.network('$imagePath/${item.image}')} else ...{AlphabetAvatar(firstname: item.firstname ?? "", lastName: item.lastname ?? "")},
                      ...
                      ContactDetailsItem(icon: MyImages.contactDetailsPhone, title: MyStrings.phoneNumber.tr, phoneNumber: "+${item.mobileCode ?? ""}${item.mobile ?? ""}"),
                      spaceDown(Dimensions.space12.h),
                      ContactDetailsItem(icon: MyImages.contactDetailsEmail, title: MyStrings.email.tr, phoneNumber: "+${item.mobileCode ?? ""}${item.mobile ?? ""}"),
                      spaceDown(Dimensions.space12.h),
                      ContactDetailsItem(icon: MyImages.contactDetailsNotes, title: MyStrings.notes.tr, phoneNumber: "+${item.mobileCode ?? ""}${item.mobile ?? ""}"),
                      ...
                      spaceDown(Dimensions.space12.h),
                      CustomElevatedBtn(text: MyStrings.viewCampaigns, onTap: () {}, bgColor: MyColor.cancelElevatedBtnBgColor),
                      spaceDown(Dimensions.space23.h),
                      Align(
                        alignment: Alignment.topLeft,
                        child: DefaultText(
                          text: MyStrings.recentActivity.tr,
                          textStyle: MyTextStyle.subHeading12W400().copyWith(fontSize: 14.sp, color: MyColor.recentActivityTextColor),
                        ),
                      ),
                      RecentlyActivityItem(icon: MyImages.messageIcon, text: MyStrings.sendWelcomeMessage.tr, subText: '2h ago'),
                      RecentlyActivityItem(icon: MyImages.planStatus, iconColor: MyColor.recentlyActivityIconColor, text: MyStrings.addedToSummerSaleCampaign.tr, subText: '2d ago'),
                      RecentlyActivityItem(icon: MyImages.messageIcon, text: MyStrings.receivedInquiry.tr, subText: '3d ago'),
                    ],
                  ),
                ),
              ),
