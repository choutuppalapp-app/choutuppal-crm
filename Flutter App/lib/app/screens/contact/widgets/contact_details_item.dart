      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: MyColor.contactDetailsICon.withAlpha(MyColor.getAlpha(10)), borderRadius: BorderRadius.circular(Dimensions.space12.r)),
            child: MyAssetImageWidget(boxFit: BoxFit.scaleDown, isSvg: true, assetPath: icon ?? '', height: 20.h, width: 20.w),
          ),
          ...
          Column(
            ...
            children: [
              DefaultText(
                text: title ?? '',
                textStyle: MyTextStyle.subHeading16W400(fontFamily: 'Nunito').copyWith(fontWeight: FontWeight.w600, fontSize: 12.sp),
              ),
              DefaultText(
                text: phoneNumber ?? '',
                textStyle: MyTextStyle.subHeading16W400(fontFamily: 'Nunito').copyWith(fontWeight: FontWeight.w600, fontSize: 14.sp),
              ),
            ],
          ),
        ],
