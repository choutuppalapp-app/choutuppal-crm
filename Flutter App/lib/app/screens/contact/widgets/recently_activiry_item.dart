...
class RecentlyActivityItem extends StatelessWidget {
  ...
  const RecentlyActivityItem({super.key, required this.icon, required this.text, required this.subText, this.iconColor});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          RoundIconWithBgColor(bgColor: MyColor.contactDetailsICon.withAlpha(MyColor.getAlpha(10)), icon: icon, height: 18, width: 18, iconColor: iconColor),
