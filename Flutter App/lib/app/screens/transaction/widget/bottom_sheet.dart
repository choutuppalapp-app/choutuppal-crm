                ...
                return Material(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Text(' ${callFrom == 2 ? AppConverter.replaceUnderscoreWithSpace(list[index].capitalizeFirst ?? '') : list[index]}', style: theme.textTheme.labelMedium?.copyWith(fontSize: Dimensions.fontDefault)),
                    ),
                  ),
                );
              },
