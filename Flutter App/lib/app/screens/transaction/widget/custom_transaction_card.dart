        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                  child: CardColumn(header: MyStrings.trxId, body: trxData, textColor: Theme.of(context).textTheme.titleLarge!.color),
                ),
                Expanded(
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: CardColumn(header: MyStrings.amount, body: '$amountData ${controller.currency}', textColor: controller.changeTextColor(trxType)),
                ),
                Expanded(
                  child: CardColumn(alignmentEnd: true, header: MyStrings.postBalance, body: '$postBalanceData ${controller.currency}'),
                ),
              ],
            ),
            ExpandedSection(
