                        ...
                        itemBuilder: (context, groupIndex) {
                          ...
                          return CustomAppCard(
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsetsDirectional.symmetric(vertical: Dimensions.space12, horizontal: Dimensions.space12),
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text(groupName.toTitleCase(), style: MyTextStyle.heading16W600UseTextColor().copyWith(fontSize: 15.sp)),
                                      CustomSwitch(
