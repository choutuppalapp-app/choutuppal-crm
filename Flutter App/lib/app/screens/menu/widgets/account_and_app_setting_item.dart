...
class AccountAndAppSettingItem extends StatelessWidget {
  ...
  const AccountAndAppSettingItem({super.key, this.title, this.subTitle, this.iconPath, required this.onTap, this.color});
      ...
      child: InkWell(
        ...
        child: Row(
          children: [
            ...
            Spacer(),
            MyAssetImageWidget(isSvg: true, assetPath: MyImages.arrowForward, height: 20.h, width: 20.w, color: MyColor.updatedTextColor),
          ],
        ),
      ),
    );
