      ...
      builder: (controller) {
        return AnnotatedRegionWidget(
          ...
          child: Scaffold(
            ...
            appBar: CustomAppBar(isShowBackBtn: false, elevation: 0, bgColor: Colors.white, title: MyStrings.accountSetting.tr),
                        ...
                        children: [
                          controller.image != ""
                              ? FittedBox(
                                  ...
                                  child: MyNetworkImageWidget(isProfile: true, boxFit: BoxFit.fill, height: 70, width: 70, radius: 100, imageUrl: controller.fullProfileUrl ?? ''),
                                )
                              : AlphabetAvatar(firstname: controller.firstName ?? '', lastName: controller.lastName ?? ''),
                          ...
                          InkWell(
                            ...
                            child: MyAssetImageWidget(isSvg: true, assetPath: MyImages.editIcon, height: 20.h, width: 20.w),
                          ),
                        ],
                      ),
                    ),
