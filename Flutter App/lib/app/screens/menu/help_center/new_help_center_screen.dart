          ...
          child: Column(
            children: [
              ...
              LabelTextField(
                ...
                onChanged: () {},
                prefixIcon: MyAssetImageWidget(isSvg: true, height: 20.h, width: 20.w, boxFit: BoxFit.scaleDown, assetPath: MyImages.search),
                fillColor: MyColor.searchFieldColor,
              ),
              spaceDown(Dimensions.space24.h),
              Column(
                children: [
                  HelpCenterItem(title: MyStrings.gettingStarted.tr, subTitle: MyStrings.gettingStartedSub.tr, iconPath: MyImages.gettingStart, onTap: () {}),
                  HelpCenterItem(title: MyStrings.accountAndBilling.tr, subTitle: MyStrings.accountAndBillingSub.tr, iconPath: MyImages.accountAndBilling, onTap: () {}),
                  HelpCenterItem(title: MyStrings.templatesAndAutomation.tr, subTitle: MyStrings.templatesAndAutomationSub.tr, iconPath: MyImages.templatesAndAutomation, onTap: () {}),
                  HelpCenterItem(title: MyStrings.troubleshooting.tr, subTitle: MyStrings.troubleshootingSub.tr, iconPath: MyImages.troubleshooting, onTap: () {}),
                ],
              ),
            ],
          ),
        ...
        child: InkWell(
          ...
          child: CustomAppCard(
            ...
            child: Row(
              ...
              children: [
                RoundIconWithBgColor(height: 16.h, width: 16.w, bgColor: MyColor.helpCenterItemBgColor, icon: iconPath ?? ''),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DefaultText(
                        text: subTitle ?? '',
                        maxLines: 2,
                        textStyle: MyTextStyle.subHeading12W400().copyWith(fontSize: 14.sp, color: MyColor.fieldTitleTextColor),
                      ),
                    ],
                  ),
                ),
                MyAssetImageWidget(assetPath: MyImages.arrowForward, isSvg: true, height: 20.h, width: 20.w, color: MyColor.updatedTextColor),
              ],
            ),
          ),
        ),
