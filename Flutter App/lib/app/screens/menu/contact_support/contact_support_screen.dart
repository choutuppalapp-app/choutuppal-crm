    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              LabelTextField(labelText: MyStrings.subject.tr, hintText: MyStrings.subjectFieldHint.tr, onChanged: () {}, fillColor: MyColor.searchFieldColor),
              spaceDown(Dimensions.space11.h),
              LabelTextField(labelText: MyStrings.issueCategory.tr, onChanged: () {}, fillColor: MyColor.searchFieldColor),
              spaceDown(Dimensions.space11.h),
              LabelTextField(labelText: MyStrings.message.tr, hintText: MyStrings.describeIssue, onChanged: () {}, fillColor: MyColor.searchFieldColor, maxLines: 6),
              spaceDown(Dimensions.space11.h),
              LabelTextField(
                readOnly: true,
                labelText: MyStrings.attachmentOptional.tr,
                hintText: MyStrings.attachAFile,
                prefixIcon: MyAssetImageWidget(assetPath: MyImages.attach, isSvg: true, height: 16.h, width: 16.w, boxFit: BoxFit.scaleDown),
                onChanged: () {},
