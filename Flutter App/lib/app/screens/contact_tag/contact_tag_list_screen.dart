      ...
      child: MyCustomScaffold(
        ...
        appBarContent: GetBuilder<ContactTagListController>(
          builder: (controller) => Row(
            children: [
              Expanded(
                child: Text(MyStrings.manageContactTag.tr, style: theme.textTheme.headlineMedium?.copyWith(color: MyColor.getHeadingTextColor())),
              ),
              ...
              Visibility(
                ...
                child: RoundIconWithBgColor(
                  ...
                  onTap: () {
                    ...
                    CustomAlertDialog(verticalPadding: 0, isHorizontalPadding: false, child: AddOrUpdateTagDialogue(isUpdate: false, id: "")).customAlertDialog(context);
                  },
                ),
              ),
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            PopupMenuButton<int>(
                                              itemBuilder: (context) {
                                                if (!MyUtils.checkPermission(AppPermission.editContactTag) && (!MyUtils.checkPermission(AppPermission.deleteContactTag))) {
                                                  ...
                                                  if (MyUtils.checkPermission(AppPermission.editContactTag))
                                                    PopupMenuItem(
                                                      onTap: () {
                                                        ...
                                                        CustomAlertDialog(verticalPadding: 0, isHorizontalPadding: false, child: AddOrUpdateTagDialogue(isUpdate: true, id: item.id.toString())).customAlertDialog(context);
                                                      },
                                                            ...
                                                            child: GetBuilder<ContactTagListController>(
                                                              builder: (context) {
                                                                return DeleteDialogue(
                                                                  warningText: MyStrings.areYouSureYouWantToDeleteThisContactTagList.tr,
