              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: BottomSheetColumn(header: MyStrings.paymentMethod, body: controller.depositList[index].gateway?.name ?? ''),
                      ),
                      Expanded(
                        child: BottomSheetColumn(alignmentEnd: true, header: MyStrings.amount, body: '${controller.curSymbol}${AppConverter.formatNumber(controller.depositList[index].amount ?? '')}'),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: BottomSheetColumn(header: MyStrings.depositCharge, body: '${controller.curSymbol}${AppConverter.formatNumber(controller.depositList[index].charge ?? '0')}'),
                      ),
                      Expanded(
                        child: BottomSheetColumn(alignmentEnd: true, header: MyStrings.payableAmount, body: '${controller.curSymbol}${AppConverter.sum(controller.depositList[index].amount ?? '0', controller.depositList[index].charge ?? '0')}'),
                      ),
                    ],
                  ),
                  const SizedBox(height: Dimensions.space20),
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: BottomSheetColumn(alignmentEnd: true, header: MyStrings.finalAmount, body: '${controller.curSymbol}${AppConverter.formatNumber(controller.depositList[index].finalAmount ?? '')}'),
                      ),
                    ],
                  ),
                ],
