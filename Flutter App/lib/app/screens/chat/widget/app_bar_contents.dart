          ...
          children: [
            controller.contact?.imageSrc != null
                ? GestureDetector(
                    ...
                    child: CircleAvatar(maxRadius: 20.r, backgroundImage: NetworkImage(controller.contact?.imageSrc ?? '')),
                  )
                : GestureDetector(
                    onTap: () {
                      if (MyUtils.checkPermission(AppPermission.viewContactProfile)) {
                    ...
                    child: AlphabetAvatar(size: 30.w, firstname: controller.contact?.firstname ?? "", lastName: controller.contact?.lastname ?? ''),
                  ),
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              DefaultText(
                                ...
                                textStyle: MyTextStyle.subHeading14W600FieldTitleColor().copyWith(color: MyColor.appBarSmallText, fontWeight: FontWeight.w400),
                                maxLines: 1,
                              ),
                            ],
                          );
                        ...
                        builder: (controller) {
                          return Column(
                            ...
                            children: [
                              ...
                              spaceDown(Dimensions.space3.h),
                              DefaultText(
                                text: "+${controller.newChatData[controller.currentChatIndex].contact?.mobileCode ?? ''} ${controller.newChatData[controller.currentChatIndex].contact?.mobile ?? ''} ",
                                textStyle: MyTextStyle.subHeading14W600FieldTitleColor().copyWith(color: MyColor.appBarSmallText, fontWeight: FontWeight.w400),
                                maxLines: 1,
                              ),
                            ],
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: MyTextStyle.subHeading14W600FieldTitleColor().copyWith(color: MyColor.getBodyTextColor(), fontWeight: FontWeight.w400),
                          ),
                        ],
                      ),
                    ),
