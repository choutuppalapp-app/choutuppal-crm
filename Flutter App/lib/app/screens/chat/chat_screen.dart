                ...
                children: [
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              if (controller.messages.length == index) {
                                return controller.hasNext() ? Container(child: controller.isSearch ? SizedBox() : const CustomLoader(isPagination: true)) : const SizedBox();
                              }
                                    ...
                                    child: IntrinsicWidth(
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          ...
                                          borderRadius: BorderRadius.only(topLeft: const Radius.circular(12), topRight: const Radius.circular(12), bottomLeft: Radius.circular(isSender ? 12 : 0), bottomRight: Radius.circular(isSender ? 0 : 12)),
                                        ),
                                        child: Column(
                                                ...
                                                children: [
                                                  Flexible(
                                                    child: InkWell(
                                                      ...
                                                      child: buildRichText(item.message.toString(), theme.textTheme.bodyLarge?.copyWith(fontSize: Dimensions.space15.sp, color: MyColor.getHeadingTextColor())),
                                                    ),
                                                  ),
                                                ],
                                              ),
                                            if (item.mediaPath != null) buildMediaWidget("${UrlContainer.domainUrl}/${controller.mediaPath}/${item.mediaPath}", item.messageType.toString(), item.mediaId ?? "", item.mimeType ?? "", index, controller),
                                            if (item.messageType.toString() == "3" || item.messageType.toString() == "4") buildMediaWidget("${item.mediaUrl}", item.messageType.toString(), item.mediaId ?? "", item.mimeType ?? "", index, controller),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.end,
                                              children: [
                                                DefaultText(
                                                  text: DateConverter.convertUtcToLocalTime(item.createdAt.toString()),
                                                  textStyle: MyTextStyle.subHeading16W400(fontFamily: 'SFPRODISPLAY').copyWith(color: MyColor.dashboardCardBorder.withAlpha(MyColor.getAlpha(50)), fontSize: 11.sp),
                                                ),
                                                if (isSender) ...[
                  ...
                  controller.isSearch
                      ...
                      : Align(
                          ...
                          child: Container(
                            padding: EdgeInsets.symmetric(vertical: Dimensions.space12.h, horizontal: Dimensions.space16.w),
                            decoration: BoxDecoration(
                              color: MyColor.white,
                                          ...
                                          if (fileType == 'image')
                                            Container(
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Image.file(controller.selectedFile!, width: context.width / 7, height: context.width / 7, fit: BoxFit.cover),
                                              ),
                                            )
                                          else
                                            Container(
                                    ...
                                    children: [
                                      PopupMenuButton<int>(
                                        itemBuilder: (context) => [
                                          PopupMenuItem(
                                            ...
                                            child: Row(
                                              children: [
                                                Icon(Icons.file_present, size: Dimensions.space25.h, color: MyColor.lightBodyText),
                                                spaceSide(Dimensions.space5),
                                                Text(
                                                  MyStrings.document.tr,
                                                  style: theme.textTheme.titleMedium?.copyWith(color: MyColor.getBodyTextColor(), fontWeight: FontWeight.w400),
                                                ),
                                              ],
                                            ),
                                          ),
                                        ...
                                        onSelected: (value) {},
                                        child: Container(
                                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.space8.h), color: MyColor.white),
                                          child: MyAssetImageWidget(assetPath: MyImages.add, isSvg: true, color: MyColor.recentlyActivityIconColor, height: Dimensions.space24.h, width: Dimensions.space24.h),
                                        ),
                                      ),
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.space8.h), color: MyColor.white),
                                          child: MyAssetImageWidget(assetPath: MyImages.gallery, isSvg: true, color: MyColor.recentlyActivityIconColor, height: Dimensions.space24.h, width: Dimensions.space24.h),
                                        ),
                                      ),
                                      spaceSide(Dimensions.space8.w),
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Padding(
                                          ...
                                          child: controller.sendingMessage
                                              ...
                                              : RoundIconWithBgColor(height: 15.h, width: 15.w, bgColor: MyColor.chatMessageSendBgColor, icon: MyImages.sendMessage, iconColor: MyColor.white),
                                        ),
                                      ),
                                    ],
                                  ),
...
Widget buildMediaWidget(String? mediaPath, String msgType, String? mediaId, String extension, int index, ChatController controller) {
  ...
  final bool isImage = lowerPath.endsWith('.jpg') || lowerPath.endsWith('.jpeg') || lowerPath.endsWith('.png') || lowerPath.endsWith('.gif') || lowerPath.endsWith('.bmp') || lowerPath.endsWith('.webp') || lowerExtension == 'jpg' || lowerExtension == 'jpeg' || lowerExtension == 'png' || lowerExtension == 'gif' || lowerExtension == 'bmp' || lowerExtension == 'webp';
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.insert_drive_file, size: Dimensions.space20, color: MyColor.getBodyTextColor().withValues(alpha: .7)),
                  SizedBox(width: 8),
                  Flexible(
                    child: Text(
                  ...
                  SizedBox(width: 8),
                  controller.downloadingFile && controller.selectedIndex == index ? CustomLoader() : Icon(Icons.download, size: Dimensions.space24, color: MyColor.getBodyTextColor().withValues(alpha: .7)),
                ],
              ),
            ),
          );
...
Widget buildRichText(String text, TextStyle? style) {
  final urlPattern = RegExp(r'(?:(?:https?|ftp):\/\/)?(?:www\.)?[a-zA-Z0-9-]+(?:\.[a-zA-Z]{2,})+(?:\/[^\s]*)?', caseSensitive: false);
