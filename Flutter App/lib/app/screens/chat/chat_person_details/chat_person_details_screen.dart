              ...
              : Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          controller.contact?.imageSrc != null ? CircleAvatar(maxRadius: Dimensions.space35.r, backgroundImage: NetworkImage(controller.contact?.imageSrc ?? '')) : AlphabetAvatar(size: Dimensions.space40.r, firstname: controller.contact?.firstname ?? "", lastName: controller.contact?.lastname ?? ''),
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: DefaultText(
                                        text: "${controller.contact?.firstname ?? ""} ${controller.contact?.lastname ?? ""}",
                                        textStyle: MyTextStyle.heading16W500UseTextColor().copyWith(fontSize: Dimensions.space18.sp),
                                        maxLines: 1,
                                      ),
                                    ),
                                    ...
                                    InkWell(
                                      onTap: () {
                                        WidgetsBinding.instance.addPostFrameCallback((_) {
                                          ...
                                          Get.toNamed(RouteHelper.customerAccountScreen, arguments: [controller.imagePath, controller.contact, true, homeController.currentChatIndex, true])?.then((_) {
                      ...
                      DefaultText(
                        ...
                        textStyle: MyTextStyle.subHeading15W500FieldTitleColor.copyWith(fontSize: 16.sp, color: MyColor.usdTextColor),
                      ),
                      spaceDown(Dimensions.space8.h),
