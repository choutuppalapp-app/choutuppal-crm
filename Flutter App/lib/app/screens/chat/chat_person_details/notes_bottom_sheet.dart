      ...
      child: GetBuilder<CustomerDetailsController>(
        builder: (controller) {
          return Container(
            ...
            padding: EdgeInsets.only(top: Dimensions.space4.h, left: Dimensions.space20.w, right: Dimensions.space20.w, bottom: Dimensions.space20.w),
            decoration: BoxDecoration(
              border: Border.all(color: MyColor.dashboardCardBorder),
              color: MyColor.white,
              borderRadius: BorderRadius.only(topLeft: Radius.circular(Dimensions.space20.r), topRight: Radius.circular(20)),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        BottomSheetCloseButton(iconColor: MyColor.errorColor, bgColor: MyColor.errorColor.withAlpha(MyColor.getAlpha(10))),
                      ],
                    ),
                  ],
                ),
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    DefaultText(
                                      text: note.note ?? "",
                                      textStyle: MyTextStyle.heading20W700().copyWith(fontWeight: FontWeight.w600, fontSize: 16.sp, color: MyColor.headingText),
                                    ),

                                    if (note.updatedAt != null) DefaultText(text: DateConverter.convertUtcToLocalTime(note.createdAt ?? ""), textStyle: MyTextStyle.subHeading12W600()),
                                  ],
                                ),
                                Material(
