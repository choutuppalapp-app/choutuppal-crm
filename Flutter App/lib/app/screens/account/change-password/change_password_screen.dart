...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(isShowBackBtn: true, elevation: 0, bgColor: MyColor.white, title: MyStrings.changePassword.tr),
        ...
        builder: (controller) => SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(MyStrings.createPasswordSubText.tr, style: MyTextStyle.subHeading12W400().copyWith(fontSize: 14.sp)),
