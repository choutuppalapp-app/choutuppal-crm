              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [MyAssetImageWidget(height: 160.h, width: 160.w, isSvg: true, assetPath: MyImages.splashScreenIcon)],
                  ),
                ),
              ],
            ),
    ...
    return SizedBox(
      ...
      child: ShaderMask(
        shaderCallback: (Rect bounds) {
          return LinearGradient(begin: Alignment.topCenter, end: Alignment.bottomCenter, colors: [Colors.white, Colors.white, Colors.white.withValues(alpha: 0)], stops: const [0.0, 0.85, 1.0]).createShader(bounds);
        },
