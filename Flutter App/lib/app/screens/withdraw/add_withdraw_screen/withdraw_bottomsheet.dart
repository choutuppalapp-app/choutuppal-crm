                        ...
                        child: controller.withdrawMethodList[index].id == -1
                            ...
                            : BottomSheetCard(
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: Text('${controller.withdrawMethodList[index].name}'.toCapitalized(), style: theme.textTheme.labelMedium?.copyWith(color: MyColor.getBodyTextColor())),
                                    ),
                                    Padding(
                                      padding: const EdgeInsetsDirectional.only(end: Dimensions.space10),
                                      child: MyNetworkImageWidget(imageUrl: ("${UrlContainer.withDrawImagePath}${controller.withdrawMethodList[index].image}"), height: Dimensions.space30, width: Dimensions.space40 + 10, boxFit: BoxFit.fitWidth),
                                    ),
                                  ],
                                ),
                              ),
