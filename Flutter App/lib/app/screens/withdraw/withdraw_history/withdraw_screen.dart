            ...
            actionButton: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(controller.isSearch ? Icons.clear : Icons.search, color: MyColor.getPrimaryColor(), size: 25),
                ),
              ),
                                ...
                                child: ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return CustomWithdrawCard(
                                      ...
                                      amount: "${AppConverter.formatNumber(withdraw.finalAmount ?? "0")} ${controller.currency}",
                                    );
                                  },
                                ),
                              ),
