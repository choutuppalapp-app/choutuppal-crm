                  ...
                  children: [
                    if (controller.isKycVerified == '2') ...[
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(MyStrings.kycVerificationPending.tr, style: theme.textTheme.headlineSmall?.copyWith(color: MyColor.pendingColor, fontSize: 17)),
                          const SizedBox(height: Dimensions.space15),
                          Text(MyStrings.kycVerificationPendingMSg.tr, style: theme.textTheme.bodyMedium?.copyWith(color: MyColor.getBodyTextColor())),
                        ],
                      ),
                    ] else ...[
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(MyStrings.kycVerificationRequired.tr, style: theme.textTheme.headlineSmall?.copyWith(color: MyColor.getErrorColor(), fontSize: 17)),
                          const SizedBox(height: Dimensions.space15),
                          Text(MyStrings.kycVerificationMsg.tr, style: theme.textTheme.bodyMedium?.copyWith(color: MyColor.getBodyTextColor())),
                        ],
                      ),
                    ],
                  ],
