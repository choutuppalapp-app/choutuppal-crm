...
class MyTheme {
  static ThemeData getThemeData({required bool isLight}) {
    return ThemeData(
      ...
      // progress bar theme
      progressIndicatorTheme: ProgressIndicatorThemeData(color: isLight ? LightThemeColors.primaryColor : DarkThemeColors.primaryColor),
