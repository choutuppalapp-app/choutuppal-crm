...
class RouteHelper {
  ...
  List<GetPage> routes = [
    ...
    GetPage(name: profileScreen, page: () => ProfileScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    ...
    GetPage(name: allContactScreen, page: () => const AllContactScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    ...
    GetPage(name: chatScreen, page: () => const ChatScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: menuScreen, page: () => const MenuScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: manageContactScreen, page: () => const ManageContactScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: contactTagListScreen, page: () => const ContactTagListScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: addNewContactGroupListScreen, page: () => const AddNewContactGroupScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: viewContactListScreen, page: () => const ViewContactScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: allContactListScreen, page: () => const AllContactListScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: customerAccountScreen, page: () => const CustomerAccountScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: helpCenterScreen, page: () => const HelpCenterScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: newHelpCenterScreen, page: () => const NewHelpCenterScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: customerDetailsScreen, page: () => const CustomerDetailsScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    ...
    GetPage(name: manageAgentScreen, page: () => const ManageAgentScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: editAgentScreen, page: () => const EditAgentScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: addNewAgentScreen, page: () => const AddNewAgentScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: agentPermissionScreen, page: () => const AgentPermissionScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: bottomNavScreen, page: () => const BottomNavBar(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(
    ...
    GetPage(name: dashboardScreen, page: () => const DashboardScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: createCampaignScreen, page: () => CreateCampaignScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: addNewContact, page: () => const AddNewContact(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: contactDetails, page: () => const ContactDetailsScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: editPersonalInformationScreen, page: () => const EditPersonalInformationScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: notificationSettingScreen, page: () => NotificationSettingScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: contactSupportScreen, page: () => ContactSupportScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: profileEditForm, page: () => ProfileEditForm(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: chatPersonDetailsScreen, page: () => ChatPersonDetailsScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
    GetPage(name: contactScreen, page: () => ContactScreen(), transitionDuration: const Duration(milliseconds: 400), transition: Transition.fadeIn),
  ];
