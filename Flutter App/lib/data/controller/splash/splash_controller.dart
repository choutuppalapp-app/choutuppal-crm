...
class SplashController extends GetxController {
  ...
  Future<void> storeLangDataInLocalStorage() async {
    ...
    if (lan.isEmpty) {
      await SharedPreferenceService.setString(SharedPreferenceService.languageNameKey, LocalizationController.myLanguages[0].languageName.toString());
    }
    if (!SharedPreferenceService.containsKey(SharedPreferenceService.countryCode)) {
      SharedPreferenceService.setString(SharedPreferenceService.countryCode, LocalizationController.myLanguages[0].countryCode);
    }
    if (!SharedPreferenceService.containsKey(SharedPreferenceService.languageCode)) {
      SharedPreferenceService.setString(SharedPreferenceService.languageCode, LocalizationController.myLanguages[0].languageCode);
    }
    Future.value(true);
  }
