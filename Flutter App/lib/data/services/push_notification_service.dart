    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage? message) async {
      ...
      if (notification != null && android != null) {
        ...
        if (android.imageUrl != null) {
          ...
          bigPictureStyle = BigPictureStyleInformation(FilePathAndroidBitmap(localImagePath), contentTitle: notification.title, summaryText: notification.body);
        }
        ...
        flutterLocalNotificationsPlugin.show(
          ...
          notificationDetails: NotificationDetails(
            android: AndroidNotificationDetails(channel.id, channel.name, channelDescription: channel.description, icon: '@mipmap/ic_launcher', playSound: true, enableVibration: true, enableLights: true, fullScreenIntent: true, priority: Priority.high, styleInformation: android.imageUrl != null ? bigPictureStyle : const BigTextStyleInformation(''), importance: Importance.high),
          ),
