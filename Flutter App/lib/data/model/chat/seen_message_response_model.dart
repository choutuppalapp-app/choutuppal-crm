...
SeenMessageResponseModel seenMessageResponseModelFromJson(String str) => SeenMessageResponseModel.fromJson(json.decode(str));
...
class SeenMessageResponseModel {
  ...
  factory SeenMessageResponseModel.fromJson(Map<String, dynamic> json) => SeenMessageResponseModel(remark: json["remark"], status: json["status"], message: json["message"] == null ? [] : List<String>.from(json["message"]!.map((x) => x)), data: json["data"] == null ? null : Data.fromJson(json["data"]));
