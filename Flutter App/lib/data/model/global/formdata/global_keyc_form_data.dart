...
class GlobalKYCForm {
  ...
  GlobalKYCForm.fromJson(dynamic json) {
    try {
      ...
      List<GlobalFormModle>? list = map.entries.map((e) => GlobalFormModle(e.value['name'], e.value['label'], e.value['is_required'], e.value['extensions'], (e.value['options'] as List).map((e) => e as String).toList(), e.value['type'], '')).toList();
