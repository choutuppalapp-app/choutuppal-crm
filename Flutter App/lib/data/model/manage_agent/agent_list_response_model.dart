...
class AgentListResponseModel {
  ...
  factory AgentListResponseModel.fromJson(Map<String, dynamic> json) => AgentListResponseModel(remark: json["remark"], status: json["status"], message: json["message"] == null ? [] : List<String>.from(json["message"]!.map((x) => x)), data: json["data"] == null ? null : Data.fromJson(json["data"]));
}
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(agents: json["agents"] == null ? null : Agents.fromJson(json["agents"]), profilePath: json["profile_path"]);
}
...
class Agents {
  ...
  factory Agents.fromJson(Map<String, dynamic> json) => Agents(data: json["data"] == null ? [] : List<AgentData>.from(json["data"]!.map((x) => AgentData.fromJson(x))), nextPageUrl: json["next_page_url"]);
}
