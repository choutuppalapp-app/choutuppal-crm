...
AgentPermissionResponseModel agentPermissionResponseModelFromJson(String str) => AgentPermissionResponseModel.fromJson(json.decode(str));
...
class AgentPermissionResponseModel {
  ...
  factory AgentPermissionResponseModel.fromJson(Map<String, dynamic> json) => AgentPermissionResponseModel(remark: json["remark"], status: json["status"], message: json["message"] == null ? [] : List<String>.from(json["message"]!.map((x) => x)), data: json["data"] == null ? null : Data.fromJson(json["data"]));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(agent: json["agent"] == null ? null : Agent.fromJson(json["agent"]), permissions: json["permissions"] == null ? [] : List<Permission>.from(json["permissions"]!.map((x) => Permission.fromJson(x))), existingPermissions: json["existing_permissions"] == null ? [] : List<Permission>.from(json["existing_permissions"]!.map((x) => Permission.fromJson(x))));

  Map<String, dynamic> toJson() => {"agent": agent?.toJson(), "permissions": permissions == null ? [] : List<dynamic>.from(permissions!.map((x) => x.toJson())), "existing_permissions": existingPermissions == null ? [] : List<dynamic>.from(existingPermissions!.map((x) => x.toJson()))};
}
...
class Agent {
  ...
  factory Agent.fromJson(Map<String, dynamic> json) => Agent(
    ...
    agentPermissions: json["agent_permissions"] == null ? [] : List<Permission>.from(json["agent_permissions"]!.map((x) => Permission.fromJson(x))),
  );
...
class Permission {
  ...
  factory Permission.fromJson(Map<String, dynamic> json) => Permission(id: json["id"]?.toString(), name: json["name"]?.toString(), guardName: guardNameValues.map[json["guard_name"]]!, groupName: json["group_name"]?.toString(), createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]), updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]), pivot: json["pivot"] == null ? null : Pivot.fromJson(json["pivot"]));

  Map<String, dynamic> toJson() => {"id": id, "name": name, "guard_name": guardNameValues.reverse[guardName], "group_name": groupName, "created_at": createdAt?.toIso8601String(), "updated_at": updatedAt?.toIso8601String(), "pivot": pivot?.toJson()};
}
...
class Pivot {
  ...
  factory Pivot.fromJson(Map<String, dynamic> json) => Pivot(agentId: json["agent_id"], agentPermissionId: json["agent_permission_id"]);
