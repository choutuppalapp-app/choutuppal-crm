...
class TwoFactorCodeModel {
  ...
  factory TwoFactorCodeModel.fromJson(Map<String, dynamic> json) => TwoFactorCodeModel(the0: json["0"], remark: json["remark"], status: json["status"], message: (json["message"] as List<dynamic>).toStringList(), data: json["data"] == null ? null : Data.fromJson(json["data"]));

  Map<String, dynamic> toJson() => {"0": the0, "remark": remark, "status": status, "message": message, "data": data?.toJson()};
}
