...
class UploadCsvResponseModel {
  ...
  factory UploadCsvResponseModel.fromJson(Map<String, dynamic> json) => UploadCsvResponseModel(remark: json["remark"], status: json["status"], message: json["message"] == null ? [] : List<String>.from(json["message"]!.map((x) => x)));
