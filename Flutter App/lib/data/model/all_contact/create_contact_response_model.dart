...
CreateContactResponseModel createContactResponseModelFromJson(String str) => CreateContactResponseModel.fromJson(json.decode(str));
...
class CreateContactResponseModel {
  ...
  factory CreateContactResponseModel.fromJson(Map<String, dynamic> json) => CreateContactResponseModel(remark: json["remark"], status: json["status"], message: json["message"] == null ? [] : List<String>.from(json["message"]!.map((x) => x)), data: json["data"] == null ? null : Data.fromJson(json["data"]));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(conversation: json["conversation"] == null ? null : Conversation.fromJson(json["conversation"]));
