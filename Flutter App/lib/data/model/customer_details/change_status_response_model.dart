...
ChangeStatusResponseModel changeStatusResponseModelFromJson(String str) => ChangeStatusResponseModel.fromJson(json.decode(str));
...
class ChangeStatusResponseModel {
  ...
  factory ChangeStatusResponseModel.fromJson(Map<String, dynamic> json) => ChangeStatusResponseModel(remark: json["remark"], status: json["status"], message: json["message"] == null ? [] : List<String>.from(json["message"]!.map((x) => x)), data: json["data"] == null ? null : Data.fromJson(json["data"]));
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(note: json["note"] == null ? null : Note.fromJson(json["note"]));
