...
class Data {
  Data({this.id, this.userId, this.sender, this.sentFrom, this.sentTo, this.subject, this.message, this.notificationType, this.image, this.userRead, this.createdAt, this.updatedAt});
