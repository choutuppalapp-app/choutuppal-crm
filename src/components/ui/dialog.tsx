...
function DialogFooter({
  ...
  return (
    // Clean border-t on the popover surface — the old gray footer band
    // read as dated chrome (docs/DESIGN.md §1).
    <div
      data-slot="dialog-footer"
      className={cn(
        "-mx-5 -mb-5 flex flex-col-reverse gap-2 rounded-b-xl border-t p-4 pt-3.5 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
