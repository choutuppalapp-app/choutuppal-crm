...
import { Bot, Sparkles, Settings2, BarChart3, Wrench } from 'lucide-react';
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@/components/ui/tabs';
import { AiPlayground } from '@/components/agents/ai-playground';
import { AiUsageCard } from '@/components/agents/ai-usage';
import { AiToolsManager } from '@/components/agents/ai-tools-manager';
        ...
        >
          <TabsList>
            ...
            <TabsTrigger value="tools">
              <Wrench className="mr-1.5 h-4 w-4" /> Tools
            </TabsTrigger>
            {canViewUsage && (
          ...
          <TabsContent value="tools" className="mt-4">
            <AiToolsManager canEdit={canViewUsage} />
          </TabsContent>
